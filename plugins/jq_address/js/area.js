...
$(function(){
		...
		$('#btntext2').click(function(){
			$("#msg2").html($('#loc_province2').select2('data').text + ' - ' + $('#loc_city2').select2('data').text + ' - ' +  $('#loc_town2').select2('data').text) 
		})
...
$(function(){
		...
		$('#btntext').click(function(){
			$("#msg").html($('#loc_province').select2('data').text + ' - ' + $('#loc_city').select2('data').text + ' - ' +  $('#loc_town').select2('data').text) 
		})
